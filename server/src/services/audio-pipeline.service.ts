...
export class AudioPipelineService {
  private sttService: SarvamSTTService;
  private llmService: SarvamLLMService;
   ...
   */
  public async startPipeline(sessionId: string): Promise<void> {
   ...
   */
  public processAudioChunk(sessionId: string, chunkBuffer: Buffer): void {
   ...
   */
  public handleInterruption(sessionId: string): void {
   ...
   */
  public async stopPipeline(sessionId: string): Promise<void> {
