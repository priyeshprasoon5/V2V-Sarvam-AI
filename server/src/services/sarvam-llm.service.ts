...
export class SarvamLLMService {
  ...
  private onTokenCallback?: (sessionId: string, token: string, isFinal: boolean) => void;
   ...
   */
  public onToken(callback: (sessionId: string, token: string, isFinal: boolean) => void) {
  ...
  public async generateStreamingResponse(
    ...
    console.log(
      `[SarvamLLMService] [Session: ${sessionId}] Requesting LLM response stream for history length: ${messages.length}`
    );
   ...
   */
  public cancelGeneration(sessionId: string): void {
